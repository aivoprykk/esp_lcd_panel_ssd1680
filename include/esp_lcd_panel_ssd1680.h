 ...
 *        Some of the ssd1680 e-paper panels support not only black pixels but also red pixels.
 ...
 *          - ESP_OK                on success
 */
esp_err_t esp_lcd_new_panel_ssd1680(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config,
 ...
 *
 * @note The SSD1680 has two separate vrams. One for black and the other for red(or maybe some other color).
 ...
 *
 * @param[in] panel LCD panel handle
 * @param[in] color a enum value, SSD1680_EPAPER_BITMAP_BLACK or SSD1680_EPAPER_BITMAP_RED
 ...
 * @param[in] size size of your lut array, make sure it is SSD1680_LUT_SIZE bytes
 * @return  ESP_OK                on success
 *          ESP_ERR_INVALID_ARG   if parameter is invalid
 */
